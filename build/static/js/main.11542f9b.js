    ...
    function c(e) {
      return function(t) {
        d.a
          ...
          .then(function(e) {
            (window.location.href = '/test-repo/build/auth/dashboard'), t({
              type: p.b,
      ...
      return function(n) {
        d.a
          ...
          .then(function(e) {
            console.log(
              e.data.courses
            ), (window.location.href = '/test-repo/build/courses/' + e.data.courses._id);
          });
      };
    }
      ...
      y = function(e, t, n) {
        ...
        return function(r) {
          console.log('This is getting called!'), d.a
            ...
            .then(function(e) {
              window.location.href = '/test-repo/build/login';
            })
            .catch(function(e) {
          ...
          d.a
            ...
            .then(function(s) {
              i({
                ...
                streetAddress: r,
                miscAddress: o,
              }), (window.location.href = '/test-repo/build/courses/' + a), console.log(window.location.href), console.log(s.data.students, 'Student response');
            });
        };
      },
          ...
          d.a
            ...
            .then(function(e) {
              console.log(
                e.data.students,
                'Checking after put'
              ), (window.location.href = '/test-repo/build/courses/' + e.data.students.courses);
            });
        };
      },
      w = function(e, t) {
          ...
          d.a
            ...
            .then(function(t) {
              v.get('instructor'), n({
                ...
                periods: [],
              }), (window.location.href = '/test-repo/build/auth/dashboard');
            });
        };
      };
  },
            ...
            value: function() {
              return console.log(this.props.error), !0 ===
                ...
                ? s.a.createElement(p.c, {
                    to: '/test-repo/build/auth/dashboard',
                  })
        ...
        return a(t, e), f(t, [
          ...
          },
          {
            ...
            value: function(e) {
              ...
              }), (window.location.href = '/test-repo/build/editStudent/' +
                this.props.id);
            },
          },
          {
            ...
            value: function(e) {
              e.preventDefault(), this.setState({
                ...
                e.target.id,
                'Check target id'
              ), (window.location.href = '/test-repo/build/courses/' +
        ...
        o.a.createElement(
          ...
          o.a.createElement(
            ...
            o.a.createElement(s.a, {
              exact: !0,
              path: '/test-repo/build/login',
              component: c.a,
            }),
            o.a.createElement(s.a, {
              exact: !0,
              path: '/test-repo/build/signup',
              component: u.a,
            }),
            o.a.createElement(s.a, {
              exact: !0,
              path: '/test-repo/build/auth/dashboard',
              component: l.a,
            }),
            o.a.createElement(s.a, {
              exact: !0,
              path: '/test-repo/build/addCourse',
              component: b.a,
            }),
            o.a.createElement(s.a, {
              exact: !0,
              path: '/test-repo/build/courses/:cuid',
              component: w.a,
            }),
            o.a.createElement(s.a, {
              exact: !0,
              path: '/test-repo/build/addStudent/:cuid',
              component: _.a,
            }),
            o.a.createElement(s.a, {
              exact: !0,
              path: '/test-repo/build/editStudent/:cuid',
              component: E.a,
            }),
            o.a.createElement(s.a, {
              exact: !0,
              path: '/test-repo/build/editCourse/:cuid',
              component: C.a,
            }),
            o.a.createElement(s.a, {
              exact: !0,
            ...
            value: function() {
              ...
              return 1 == this.state.isClicked
                ? s.a.createElement(c.c, {
                    to: '/test-repo/build/courses/' + this.state.coursename,
                  })
                : s.a.createElement(
                    'div',
                    {
        ...
        return a(t, e), h(t, [
          {
            key: 'onClick',
            value: function(e) {
              e.preventDefault(), (window.location.href = '/test-repo/build/courses/' +
                e.target.id);
            },
          },
          {
          ...
          },
          {
            ...
            value: function() {
              var e = this;
              this.state.authenticated ||
                (window.location.href = '/test-repo/build/login'), console.log(
                this.state.authenticated,
      ...
      navigator.hasOwnProperty('serviceWorker') &&
        ...
        window.addEventListener('load', function() {
          navigator.serviceWorker
            .register('/test-repo/build/service-worker.js')
            .then(function(e) {
